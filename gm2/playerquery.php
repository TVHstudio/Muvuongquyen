...
if($_POST){
	...
	switch($act){
		...
		case 'mail':
			...
			$uid=$row['actorid'];
			$sql="INSERT INTO gmcmd (serverid,cmdid,cmd,param1,param2,param3,param4,param5) VALUES ('{$srvid}','1','sendMail','Thư qcymw.com', 'Nhận quà thành công','{$uid}','{$type},{$itemid},{$num}','')";
            $obj = mysqli_query($conn,$sql);
			mysqli_close($conn);
			}
				$return=array(
